...
//Метод splice используется для изменения содержимого массива, добавления или удаления элементов. Он может принимать несколько аргументов:
// Начальный индекс: Индекс, с которого начнется изменение массива.
// Количество элементов для удаления: Число элементов, которые нужно удалить.
// Элементы для добавления: Новые элементы, которые нужно добавить.
// Удалить 2 элемента, начиная с индекса 2, и добавить 6 и 7
